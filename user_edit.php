...
if (isset($_SESSION['id_user'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['zip']) && $_POST['zip'] != null) {
            if (get_numrows($_POST['zip'], 'zip', 'zip_code') == 0) {
                if (isset($_POST['region']) && isset($_POST['region']) != NULL) {
                    $sql = "INSERT INTO zip_code(zip, region) values(" . $_POST['zip'] . ",'" . $_POST['region'] . "')";
                    unset($_POST['region']);
                } else
                    $sql = "INSERT INTO zip_code(zip) values('" . $_POST['zip'] . "')";
                $query = mysqli_query($conn, $sql);
                unset($_POST['zip']);
            }
        }
        $table = "users";
        $condition = "id_user =" . $_SESSION['id_user'];
                        ...
                        <div class="p-3 p-lg-5 border">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <img id="blah" alt="your image" style="max-width:100px;" /><br>
