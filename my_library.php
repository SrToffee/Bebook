...
if (!empty($_GET)) {
    ...
    switch ($aux[0]) {
        case 'id_gender':
            $sql = "SELECT book.* from book, book_gender, book_user where book_user.id_book = book.id_book && book_user.id_user =" . $_SESSION['id_user'] . " && book.stat = 1 && book_gender.id_book = book.id_book && book_gender.id_gender=" . $_GET[$aux[0]];
            ...
            break;
        case 'id_pub':
            $sql = "SELECT  book.* from book, book_user where book_user.id_book = book.id_book && book_user.id_user =" . $_SESSION['id_user'] . " && id_pub=" . $_GET[$aux[0]];
            ...
            break;
        case 'id_author':
            $sql = "SELECT book.* from book, book_author , book_user where book_user.id_book = book.id_book && book_user.id_user =" . $_SESSION['id_user'] . " && book_author.id_book = book.id_book && book_author.id_author=" . $_GET[$aux[0]];
    ...
    $sql = "SELECT  book.* from book, book_user where book_user.id_book = book.id_book && book_user.id_user =" . $_SESSION['id_user'];
}
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-5">
                                <div class="float-md-left mb-4">
                                    <h2 class="text-black h5">Biblioteca</h2>
                                </div>
                                <div class="d-flex">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                                while ($row = mysqli_fetch_assoc($result))
                                                    echo '<a class="dropdown-item" href="my_library.php?id_gender=' . $row['id_gender'] . '">' . $row['name'] . '</a>';
                                            ?>
                                        </div>
                                    </div>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                                            ...
                                            <a class="dropdown-item" href="#">Preço baixo -> alto</a>
                                            <a class="dropdown-item" href="#">Preço Alto -> baixo</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                while ($row = mysqli_fetch_assoc($query)) {
                                    ...
                                    <div class="block-4 text-center border">
                                        ...
                                        <div class="block-4-text p-4">
                                            <h3><a href="book_page.php?id_book=' . $row['id_book'] . '">' . $row['name'] . '</a></h3><br>
                    ...
                    <div class="col-md-3 order-1 mb-5 mb-md-0">
                        <div class="border p-4 rounded mb-4">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                if (mysqli_num_rows($result) > 0)
                                    while ($row = mysqli_fetch_assoc($result))
                                        echo '<li class="mb-1"><a href="my_library.php?id_pub=' . $row['id_pub'] . '" class="d-flex"><span>' . $row['name'] . '</span></a></li>';
                                ?>
                            </ul>
                        </div>
                        <div class="border p-4 rounded mb-4">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                if (mysqli_num_rows($result) > 0)
                                    while ($row = mysqli_fetch_assoc($result))
                                        echo '<li class="mb-1"><a href="my_library.php?id_author=' . $row['id_author'] . '" class="d-flex"><span>' . $row['name'] . '</span></a></li>';
                                ?>
                            </ul>
                        </div>
                    </div>
