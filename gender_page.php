...
if (isset($_GET['id_gender'])) {
  $sql = "SELECT * FROM gender where id_gender =" . $_GET['id_gender'];
  $gender_query = mysqli_query($conn, $sql);
  if (mysqli_num_rows($gender_query) == 1) {
    $row = mysqli_fetch_assoc($gender_query);
  } else
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="<?php echo $row['pic'] ?>" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="nonloop-block-3 owl-carousel">
                      <?php
                      $sql = "SELECT  book.* 
                from book, book_gender
                where book.stat = 1 && book.id_book = book_gender.id_book && book_gender.id_gender = " . $row['id_gender'];
