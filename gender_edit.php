...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $table = "gender";
    $condition = "id_gender =" . $_POST['id_gender'];
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                ...
                <div class="container">
                    <p><strong class="text-primary h4">Alterar Género</strong></p>
                    <form name="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" onsubmit="return validation()" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id_gender" value="<?php echo $_GET['id_gender'] ?>">
                        <div class="row">
                            <div class="col-md-6">
